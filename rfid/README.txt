...
3. In ./rfid/apps, 'sudo GR_SCHEDULER=STS nice -n -20 ./gen2_reader.py'
   (or gen2_monitor.py)
...
./rfid/misc_files/fusb_linux.cc needs to be copied to usrp/host/lib/
...
the standard files of GNU Radio. In general, the modified files should
